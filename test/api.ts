...
describe("LaTeX.js API test", () => {
	...
	test("fs DOM API", async () => {
		...
		expect(file.toString()).toBe(
			`<div class="body" data-line="1" data-column="1"><p data-line="1" data-column="1">Hi, this is a line of text.</p></div>${EOL}`,
		);
	});
});
